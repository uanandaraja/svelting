...
<!-- Toggle button + New Chat - always rendered, visibility controlled by CSS -->
<div
	class="fixed top-4 left-4 z-50 flex items-center gap-2 transition-all duration-300"
...
>
	<button
		type="button"
		onclick={onToggle}
		class="p-2.5 rounded-xl bg-muted/80 backdrop-blur-sm hover:bg-accent text-foreground/70 hover:text-foreground transition-all"
