...
<div class="min-h-screen bg-background flex flex-col items-center justify-center p-8">
	<div class="w-full max-w-sm">
		<div class="text-center mb-8">
			<h1 class="text-3xl font-semibold text-foreground mb-2">svelting</h1>
		...
		<p class="text-center text-sm text-muted-foreground mt-6">
			<a href="/" class="hover:text-foreground transition-colors">← back home</a>
		</p>
	</div>
</div>
